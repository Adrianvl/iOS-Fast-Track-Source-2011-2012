...
- (IBAction)doStartButton:(id)sender {
    ...
    void(^completionBlock)(void) = ^ {
        [self performSelectorOnMainThread:@selector(block3AHasFinished:) withObject:nil waitUntilDone:NO];        
    };
    ...
    //When all is done
    [blockOperation3A setCompletionBlock:completionBlock];
...
-(void)block3AHasFinished:(id)obj
{
