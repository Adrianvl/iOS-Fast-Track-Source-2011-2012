...
- (id) init
{
	...
	if (self != nil) {
		...
		[dictionaryOfSections setObject:records forKey:@"Popular Pets"];
		
		//Section 1 - dangerous pets
		records = [NSArray arrayWithObjects:@"Snow Leopard", @"Spitting Cobra", @"Rhino", nil];
		[dictionaryOfSections setObject:records forKey:@"Dangerous Pets"];
		...
		[dictionaryOfSections setObject:records forKey:@"Surreal Pets"];	
