...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"ViewController 2 recieved message viewDidLoad ");
...
- (void)didReceiveMemoryWarning {
    ...
    NSLog(@"ViewController 2 recieved message didReceiveMemoryWarning ");
...
- (void)viewDidUnload {
    ...
    NSLog(@"ViewController 2 recieved message viewDidUnload ");
